...
/**
 * This class calculates the sound speed in seawater
 *
 * @author pedro
 */
...
public class SoundSpeedInSeaWater {
     ...
     */
    public double getSoundSpeedChenMillero(double pressure, double salinity, double temp) {
        ...
        return C + A * S + B * Math.pow(S, 1.5) + D * S * S;
    }// getSoundsSpeedChengMIllero
}
